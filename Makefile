# This Makefile is for the DeDup extension to perl.
#
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: DeDup' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "DeDup",' >> META_new.json
